...
public class LifeLineService extends FullscreenService
    ...
    private class BatteryReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            lineView.setCharging(isCharging);
        }
    }
    ...
    private void loadColorPreference() {
        ...
        lineView.setAdvancedColors(preferences.getBoolean(LifeLinePreferences.PREF_ADVANCED_COLORS, false));
    }

    /**
     * Updates properties of the view.
     *
     * @param preferences The application wide LifeLine preferences.
     * @param key         The Preference which has changed it's value.
     */
    @Override
    public void onSharedPreferenceChanged(SharedPreferences preferences, String key) {
        if (key.equals(LifeLinePreferences.PREF_COLOR) || key.equals(LifeLinePreferences.PREF_ADVANCED_COLORS)) {
            loadColorPreference();
        }
    }
